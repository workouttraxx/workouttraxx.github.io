...
// $TARGET_EMAIL = array(EMAIL_NAME."@rouveen-kaasspecialiteiten\.nl$");
$TARGET_EMAIL = array(EMAIL_NAME."@xfact\.nl$",
    EMAIL_NAME."@gmail\.com$",
    EMAIL_NAME."@workouttraxx\.com$",
    EMAIL_NAME."@lms.lifeline\.nl$",
    EMAIL_NAME."@xs4all\.nl$"
    ); 
...
$FROM_USER = "Webformulier Acuive";                            // the default - setting not used
...
$FIXED_SENDER = "webformulier@rouveen-kaasspecialiteiten.nl";
...
define('MSG_PLSWAIT_REDIR',9);      // Een moment geduld alstublieft...
...
define('MSG_FM_ALERT',16);          // Formulier waarschuwing
define('MSG_FM_ERROR',17);          // Formulier scriptfout
define('MSG_FM_ERROR_LINE',18);     // De volgende fout is opgetreden...
...
define('MSG_INV_EMAIL',93);         // Ongeldig e-mailadres...
...
function LoadBuiltinLanguage()
{
    ...
    $aMessages[MSG_INFO_STOPPED] = '(Extra alert information suppressed for '.
        ...
        // Parameters: none
    $aMessages[MSG_FM_ALERT] = 'Formulier waarschuwing';

        // MSG_FM_ERROR is sent as the subject line of an Alert message
        // Parameters: none
    $aMessages[MSG_FM_ERROR] = 'Formulier foutmelding';

        // MSG_FM_ERROR_LINE is sent in an Alert message on a
        // separate line to introduce the actual error message
        // Parameters: none
    $aMessages[MSG_FM_ERROR_LINE] = 'De volgende fouten zijn opgetreden bij het versturen van het formulier $MNUM:';
    ...
    $aMessages[MSG_OPEN_TEMPLATE] = 'Failed to open template "$NAME" $MNUM: $ERROR';
        ...
        // Parameters: none
    $aMessages[MSG_ERROR_PROC] = 'Een fout is opgetreden bij het versturen van het '.
                                 'formulier $MNUM.\n\n';
